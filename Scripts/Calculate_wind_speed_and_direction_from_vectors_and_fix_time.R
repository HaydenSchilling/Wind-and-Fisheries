...
mydata <- read.csv("Wind DataV3/Wind_data_full_all_estuaries_vectors.csv", header = T)
head(mydata)
...
fwrite(mydata, "Wind DataV3/All Estuaries Modelled Wind Data speed direction.csv", row.names = FALSE)
