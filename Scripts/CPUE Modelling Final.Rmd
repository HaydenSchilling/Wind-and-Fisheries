...
ggsave("../plots/Upwelling Winds by species_time_estuary.png", height = 14.8, width=21, dpi =600)
...
ggsave("../plots/Downwelling Winds by species_time_estuary.png", height = 14.8, width=21, dpi =600)
...
p2 <- plot(ggeffect(m2, terms = c("Drought_Months", "Estuary_Type"))) + ggtitle("d) Mullet")+ theme(legend.position = "bottom")
p3 <- plot(ggeffect(m3, terms = c("Drought_Months", "Estuary_Type"))) + ggtitle("e) Whiting")+ theme(legend.position = "bottom")
...
library(patchwork)
p1 + p5 + p4+ p2 +p3 +plot_layout(nrow = 2, guides = "collect")+ plot_layout(guides = "collect") & 
