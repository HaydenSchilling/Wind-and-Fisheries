# Larval 3 day model bayesian brms
...
# 
# saveRDS(fit5, "../Data/Coastal 3 day brms model.rds")
fit5 <- readRDS("../Data/Coastal 3 day brms model.rds")
...
fit5 %>%
  gather_draws(b_Intercept, b_polyNE_Winds.standardiseddegreeEQ21,
               ...
               `b_dists_km:polySE_Winds.standardiseddegreeEQ22`, `b_dists_km:polySE_Winds.standardiseddegreeEQ21`) %>%
  median_qi() #%>%
  #write_csv("../Data/Larval fish model coefs 3 day Bayesian.csv")
...
#ggsave("../plots/Larvae heatmap 3 day bayesian.png", width = 21, height = 14.8, units = "cm", dpi = 600)
...
ggsave("../plots/Larvae 3 day plots_Bayesian.png", width = 21, height = 14.8, units = "cm", dpi = 600)
ggsave("../plots/Larvae 3 day plots_Bayesian.pdf", width = 21, height = 14.8, units = "cm", dpi = 600)
