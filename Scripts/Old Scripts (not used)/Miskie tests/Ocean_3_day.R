...
write.csv(A_test,"Anova Ocean 3 days 50km.csv", row.names = F)
S_test <- broom.mixed::tidy((fit4))
write.csv(S_test,"Summary Ocean 3 days 50km.csv", row.names = F)
...
write.csv(heat_dataM, "Heat data Ocean 3 day 50km.csv", row.names = F)
...
ggsave("Ocean 3 day plots_Alternate 50km.png", width = 21, height = 14.8, units = "cm", dpi = 600)
