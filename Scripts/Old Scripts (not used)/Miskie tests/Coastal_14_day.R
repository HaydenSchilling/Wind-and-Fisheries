...
write.csv(A_test,"Anova Coastal 14 days 50km.csv", row.names = F)
S_test <- broom.mixed::tidy((fit4))
write.csv(S_test,"Summary Coastal 14 days 50km.csv", row.names = F)
...
write.csv(heat_dataM, "Heat data Coastal 14 day 50km.csv", row.names = F)
...
ggsave("Coastal 14 day plots_Alternate 50km.png", width = 21, height = 14.8, units = "cm", dpi = 600)
