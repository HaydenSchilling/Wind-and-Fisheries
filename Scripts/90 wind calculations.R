# Calculate adjusted wind for direct east to west
# Hayden Schilling 3_10_19
...
mydata$Onshore_Offshore[mydata$Direction < 180 & mydata$Direction > 0] <- "Onshore"
...
mydata$Wind.effect.size = sin((mydata$Direction)*pi/180)
...
# }
 ...
 write.csv(dat_SE, "Iain/Iain Annual 90 degree winds Sydney_new.csv", row.names = F)
