...
file_list <- list.files("../../srv/scratch/z3374139/Model_Wind_Data/u_data/", pattern = ".nc")
file_names <- paste("../../srv/scratch/z3374139/Model_Wind_Data/u_data/", file_list, sep = "")
...
file_list <- list.files("../../srv/scratch/z3374139/Model_Wind_Data/v_data/", pattern = ".nc")
file_names <- paste("../../srv/scratch/z3374139/Model_Wind_Data/v_data/", file_list, sep = "")
save_names <- file_path_sans_ext(file_names)
...
# U data first
file_list <- list.files("../../srv/scratch/z3374139/Model_Wind_Data/u_data/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Model_Wind_Data/u_data/", file_list, sep = "")
...
# now V data
file_list <- list.files("../../srv/scratch/z3374139/Model_Wind_Data/v_data/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Model_Wind_Data/v_data/", file_list, sep = "")
...
fwrite(full_data, file = "../../srv/scratch/z3374139/Model_Wind_Data/Wind_data_full_all_estuaries_vectors.csv")
head(full_data)
