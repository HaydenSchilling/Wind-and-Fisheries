...
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/u wind/", pattern = ".nc")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/u wind/", file_list, sep = "")
file_names2 <- paste("../../srv/scratch/z3374139/Wind DataV3/Dannevig/u wind/", file_list, sep = "")
save_names <- file_path_sans_ext(file_names2)

estuary_info <- read.csv("Dannevig Lat Longs.csv", header = T)
...
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/v wind/", pattern = ".nc")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/v wind/", file_list, sep = "")
file_names2 <- paste("../../srv/scratch/z3374139/Wind DataV3/Dannevig/v wind/", file_list, sep = "")
save_names <- file_path_sans_ext(file_names2)
...
# U data first
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/Dannevig/u wind/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/Dannevig/u wind/", file_list, sep = "")
...
# now V data
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/Dannevig/v wind/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/Dannevig/v wind/", file_list, sep = "")
...
fwrite(full_data, file = "../../srv/scratch/z3374139/Wind DataV3/Wind_data_Dannevig_vectors.csv")
head(full_data)
