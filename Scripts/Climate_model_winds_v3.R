...
# U data first
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/u wind/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/u wind/", file_list, sep = "")
...
# now V data
file_list <- list.files("../../srv/scratch/z3374139/Wind DataV3/v wind/", pattern = ".csv")
file_names <- paste("../../srv/scratch/z3374139/Wind DataV3/v wind/", file_list, sep = "")
...
fwrite(full_data, file = "../../srv/scratch/z3374139/Wind DataV3/Wind_data_full_all_estuaries_vectors.csv")
head(full_data)
